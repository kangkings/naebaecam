package com.springcloud.eureka.product1;
...
public class ProductController {
    ...
    public String getProductBy(@PathVariable("product_id") String id) {
        return "Product detail from PORT : " + serverPort + " and message : " + this.message + id;
    }
}
